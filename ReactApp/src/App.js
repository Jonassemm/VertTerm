...
import OptionalAttributesPage from "./components/optionalAttributesComponents/optionalAttributesPage"
...
const OptionalAttributesPage = React.lazy(() => import('./components/optionalAttributesComponents/optionalAttributesPage'))
...
const AppointmentPage = React.lazy(() => import("./components/appointmentComponents/AppointmentPage")) */
      ...
      <Suspense fallback={<div>loading...</div>}>
        <div style={{ margin: "55px 0px 50px 0px" }}>
          <Switch>
            ...
            <Route exact path="/appointment" component={() => (<AppointmentPage calendarStore={calendarStore} userSelect={false}/>)} />
