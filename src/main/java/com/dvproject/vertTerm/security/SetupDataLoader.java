...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void setupRights () {
		...
		setupRight("OWN_USER_WRITE", "�ndern des eigenen Benutzers erlaubt");
		setupRight("USER_READ", "Lesen aller Benutzers erlaubt");
		setupRight("USER_WRITE", "�ndern aller Benutzers erlaubt");
		
		// employee
		setupRight("OWN_EMPLOYEE_READ", "Lesen des eigenen Angestellten erlaubt");
		setupRight("OWN_EMPLOYEE_WRITE", "�ndern des eigenen Angestellten erlaubt");
		setupRight("EMPLOYEE_READ", "Lesen aller Angestellter erlaubt");
		setupRight("EMPLOYEE_WRITE", "�ndern aller Angestellter erlaubt");
		
		// position
		setupRight("POSITION_READ", "Lesen aller Positionen erlaubt");
		setupRight("POSITION_WRITE", "�ndern aller Positionen erlaubt");
		
		// customer
		setupRight("OWN_CUSTOMER_READ", "Lesen des eigenen Kunden erlaubt");
		setupRight("OWN_CUSTOMER_WRITE", "�ndern des eigenen Kunden erlaubt");
		setupRight("CUSTOMER_READ", "Lesen aller Kunden erlaubt");
		setupRight("CUSTOMER_WRITE", "�ndern aller Kunden erlaubt");
		
		// role
		setupRight("ROLE_READ", "Lesen aller Kunden erlaubt");
		setupRight("ROLE_WRITE", "�ndern aller Kunden erlaubt");
		...
		setupRight("RESOURCE_WRITE", "�ndern aller Ressourcen erlaubt");
		
		// resourceType
		setupRight("RESOURCE_TYPE_READ", "Lesen aller Ressourcentypen erlaubt");
		setupRight("RESOURCE_TYPE_WRITE", "�ndern aller Ressourcentypen erlaubt");
		
		// procedure
		setupRight("PROCEDURE_READ", "Lesen aller Prozeduren erlaubt");
		setupRight("PROCEDURE_WRITE", "�ndern aller Prozeduren erlaubt");
		setupRight("PROCEDURE_RELATION_WRITE", "�ndern aller Prozeduren erlaubt");
		
		// availability
		setupRight("OWN_AVAILABILITY_WRITE", "�ndern der eigenen Verf�gbarkeiten erlaubt");
		setupRight("AVAILABILITY_WRITE", "�ndern aller Verf�gbarkeiten erlaubt");
		
		// appointment
		setupRight("OWN_APPOINTMENT_READ", "Lesen der eigenen Termine erlaubt");
		setupRight("OWN_APPOINTMENT_WRITE", "�ndern der eigenen Termine erlaubt");
		...
		setupRight("APPOINTMENT_WRITE", "�ndern aller Termine erlaubt");
